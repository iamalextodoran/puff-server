...
a3 = Transaction.create(category: "food", user: u3, name: "mere", description: "no ndeed for that thing", amount: "324", type_of_t: "expense");
a4 = Transaction.create(category: "beverage", user: u3, name: "bere", description: "no ndeed for that thing", amount: "100", type_of_t: "expense");
a5 = Transaction.create(category: "beverage", user: u3, name: "apa", description: "no ndeed for that thing", amount: "20", type_of_t: "expense");
a6 = Transaction.create(category: "beverage", user: u3, name: "suc", description: "no ndeed for that thing", amount: "30", type_of_t: "expense");
a7 = Transaction.create(category: "savings", user: u3, name: "hawaii", description: "no ndeed for that thing", amount: "540", type_of_t: "income");
